...
def create_app_ui():
  ...
  main_layout = html.Div([
      html.H1('Terrorism Analysis with Insights', id='Main_title',style = {'backgroundColor': '#00005c',
                                                                       'text-align': 'center',
                                                                       'color':'white'}),
      ...
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map",style=tab_style, selected_style=tab_selected_style, children=[
          dcc.Tabs(id = "subtabs", value = "WorldMap",children = [
              dcc.Tab(label="World Map tool", id="World",style=tab_style, selected_style=tab_selected_style, value="WorldMap"),
              dcc.Tab(label="India Map tool", id="India",style=tab_style, selected_style=tab_selected_style, value="IndiaMap")
              ]),html.Br(),
          dcc.Dropdown(
              id='month', 
                options=month_list,
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart",style=tab_style, selected_style=tab_selected_style, children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",children = [
              dcc.Tab(label="World Chart tool", id="WorldC",style=tab_style, selected_style=tab_selected_style, value="WorldChart"),          
            dcc.Tab(label="India Chart tool", id="IndiaC",style=tab_style, selected_style=tab_selected_style, value="IndiaChart")]),
            html.Br(),
...
def main():
  ...
  print("This is executed only when the program is closed")
  df = None
  app = None
